    ...
    <div style={{ 
      ...
      <div style={{ width: "100%", maxWidth: 400, padding: "40px", background: "var(--bg)", borderRadius: "16px" }}>
        ...
        <div style={{ marginBottom: 40, textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-mono)", fontSize: 32, fontWeight: 800, letterSpacing: "-1px", color: "var(--text)" }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          <div>
            <label style={{ fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--text-dim)", marginBottom: 8, display: "block" }}>Display Name</label>
            <input
              type="text"
